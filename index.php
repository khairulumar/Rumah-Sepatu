...
<head>
	<!-- start: Meta -->
	<meta charset="utf-8">
	<title>Rumah Sepatu | Sepatu Online telengkap dan terpercaya di pekalongan</title> 
...
<body>
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="logo span3">
					...
					<a class="brand" href="#"><img src="img/logors.png" alt="Logo"></a>
	...
	<div class="slider-wrapper">
		...
		<div id="da-slider" class="da-slider">
			<div class="da-slide">
				<h2>Sepatu Futsal</h2>
				<p>Kami menyediakan sepatu sport dan casual yang nyaman anda kenakan setiap hari juga update dengan perkermbangan mode di era sekarang ini.</p>
				<a href="#" class="da-link">Lihat Produk</a>
				<div class="da-img"><img src="img/parallax-slider/sepatu.jpg" alt="image01" /></div>
			</div>
			<div class="da-slide">
				<h2>Sepatu Voly</h2>
				<p>Kami memiliki banyak koleksi Sepatu Volly, mulai dari bermerk hingga bergaransi dan juga ada yang cocok dipakai sehari hari.</p>
				<a href="#" class="da-link">Lihat Produk</a>
				<div class="da-img"><img src="img/parallax-slider/sepatu1.png" alt="image02" /></div>
			</div>
			<div class="da-slide">
				<h2>Sepatu Kitten Heels</h2>
				<p>Kitten heels cocok dipakai oleh wanita trendy dan modis untuk acara yang formal maupun acara yang lebih santai. Ada beragam variasi model, bahan, warna, dan ukuran kitten heels merek terkenal yang bisa dibeli di butik-butik fashion atau online shop secara eceran maupun dengan harga grosir.</p>
				<a href="#" class="da-link">Lihat Produk</a>
				<div class="da-img"><img src="img/parallax-slider/sepatu2.jpg" alt="image03" /></div>
			</div>
			<div class="da-slide">
				<h2>Sepatu Tennis</h2>
				<p>Rasakan kenyamanan yang luar biasa dengan menggunakan sepatu ini saat bermain tenis. Terbuat dari bahan-bahan yang telah dipilih secara khusus dan diuji kekuatannya agar sepatu ini menjadi tahan lama dan kuat. Cocok untuk Anda yang menyukai gaya trendi dan sporty.</p>
				<a href="#" class="da-link">Lihat Produk</a>
				<div class="da-img"><img src="img/parallax-slider/sepatu3.jpg" alt="image04" /></div>
			</div>
			<nav class="da-arrows">
